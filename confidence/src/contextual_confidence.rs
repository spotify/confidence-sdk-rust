...
use crate::{Confidence, ConfidenceValue};
...
mod tests {
    ...
    #[test]
    fn test_with_context_keeps_resolve_base_url() {
        let confidence = Confidence::builder()
            .api_config(APIConfig {
                api_key: "X".to_string(),
                region: Region::EU,
        ...
        let new_confidence = confidence.with_context(HashMap::new());

        assert_eq!(
            new_confidence.api_config.resolve_base_url,
